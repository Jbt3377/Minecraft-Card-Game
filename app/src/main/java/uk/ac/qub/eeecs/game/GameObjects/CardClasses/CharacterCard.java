...
public class CharacterCard extends Card {
    ...
    public CharacterCard(float x, float y, GameScreen gameScreen, int index, CharacterCardStats characterCardStats) {
        super(x, y, gameScreen, index);
        this.hp = characterCardStats.getHp();
        this.attack = characterCardStats.getAttack();
        this.equipCard = null;
    }
